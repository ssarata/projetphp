...
//ar_dump($client2->__destruct());
/*$client4= new CheckingAccount(30,3);

$client5= new SavingsAccount(40,10);

$client4->deductTransactionFee(2);
var_dump($client5->addInterest(10));*/

$client4= new CheckingAccount(30,3,1);

$client5= new SavingsAccount(40,10,10);

$client4->deductTransactionFee();
var_dump($client5->addInterest());
